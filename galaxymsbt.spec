...
a = Analysis(
    ...
    datas=[
        ...
        ('assets/tool_msb_add.png', 'assets'),
        ('assets/tool_msb_delete.png', 'assets'),
        ('assets/tool_message_add.png', 'assets'),
        ('assets/tool_message_delete.png', 'assets'),
        ('assets/tool_message_duplicate.png', 'assets'),
        ('assets/tool_message_sort.png', 'assets'),
        ('assets/tool_flow_add.png', 'assets'),
        ('assets/tool_flow_remove.png', 'assets'),
        ('assets/tool_flow_duplicate.png', 'assets'),
    ],
    hiddenimports=[],
    hookspath=[],
    hooksconfig={},
